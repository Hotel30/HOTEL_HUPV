...
<div class="main-content">
    ...
    <form action="{{ route('reservaciones.store') }}" method="POST">
        ...
        <div class="input-group">
            ...
            <select id="hotel_id" name="hotel_id" class="form-control styled-select" onchange="fetchOptions()" required>
        ...
        <div class="input-group">
            ...
            <select id="tipo_habitacion_id" name="tipo_habitacion_id" class="form-control styled-select" onchange="fetchOptions()" required>
        ...
        <div class="input-group">
            <label for="habitaciones">Número de Habitación</label>
            <select id="habitaciones" name="habitaciones[]" class="form-control styled-select">
        ...
        <div class="input-group">
            <div id="inventario" class="inventory-container">
        ...
        <div class="button-group">
            <a href="{{ route('reservaciones.index') }}" class="cancel-button">Cancelar</a>
            <button type="submit" class="cancel-button">Reservar</button>
        </div>
    </form>
</div>
        ...
        fetch(`/api/filtrar-datos?hotel_id=${hotelId}&tipo_habitacion_id=${tipoHabitacionId}`)
            ...
            .then(data => {
                ...
                data.inventario.forEach(item => {
                    inventarioDiv.innerHTML += `
                            <div class="form-group inventory-item">
